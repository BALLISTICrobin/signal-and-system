...
sample_rate, data = wavfile.read('signals and systems practices/fourierTransform/buzzjc.wav')
...
# (frequencies >= 878) &(frequencies <= 882) | 
# (frequencies >= 658) &(frequencies <= 661) 
# Filter out the frequencies for which you get the best result.
...
mask = ((frequencies >= 0) & (frequencies <= 999))
...
wavfile.write('signals and systems practices/fourierTransform/denoised_audio.wav', sample_rate, filtered_data)
